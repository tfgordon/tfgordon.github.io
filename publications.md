...
- Walton, Douglas and Gordon, Thomas F. (2017). [Cumulative Arguments
  ...
  Logic](publications/WaltonGordon2017a-Cumulative.pdf). Revista
  de Argumentacion, (14), 1-28.

# 2016

- Gordon, Thomas F. and Walton, Douglas
  (2016). [Formalizing Balancing Arguments](publications/GordonWaltonCOMMA2016.pdf). Proceedings
...
- Gordon, Thomas F. 2015. [Still craving a Porsche](publications/Gordon2015a.pdf). In
...
- Gordon, Thomas F. (2014). [Software Engineering for Research on Legal
  Argumentation](publications/Gordon2014a.pdf). Proceedings of the First International Workshop for
  Research on Legal Argumenation (MET-ARG)
- Gordon, Thomas F.. "[A Demonstration of the MARKOS License Analyser."
  In Computational Models of Argument](publications/Gordon2014b.pdf) – Proceedings of COMMA 2014,
...
- Walton, D. N.; Tindale, C. W. & Gordon, T. F. (2014), '[Applying
  ...
  Reasoning](publications/WaltonTindaleGordon2014a.pdf)', Argumentation 28(1), 85–119. (Doi: 10.1007/s10503-013-9306-y.)

# 2013

- Gordon, T. F. (2013). [Structured Consultation with Argument
  Graphs](publications/Gordon2013a.pdf). In K. Atkinson, H. Prakken & A. Wyner (ed.), From Knowledge
  Representation to Argumentation in AI, Law and Policy Making
  (pp. 115–134). College Publications.
- Gordon, T. F. (2013), [Introducing the Carneades Web Application](publications/Gordon2013b.pdf), in
...
- Ceci, M., and Gordon,  T. F. [Browsing case-law: An application of the Carneades argumentation system](http://ceur-ws.org/Vol-874/paper8.pdf). In
  ...
  pp. 79–95.
- Gordon, T. F. [The Carneades web service](publications/Gordon2012a.pdf). In Computational Models of
...
- Bex, F., Gordon, T., Lawrence, J., and Reed, C. [Interchanging
  arguments between Carneades and AIF](publications/BexGordonLawrenceReed2012.pdf). In Computational Models of
...
- Walton, D. and Gordon, T. F. (2012). [The Carneades model of argument
  invention](publications/WaltonGordon2012a.pdf). Pragmatics & Cognition, 20(1):1–31.
- Gordon, T. F., and Walton, D. [A Carneades Reconstruction of Popov v
  Hayashi](publications/GordonWalton2012a.pdf). Artificial Intelligence and Law 20, 1 (2012),
  37–56. doi:10.1007/s10506-012-9120-0

# 2011

- Gordon, Thomas F. 2011. [The Policy Modeling Tool of the IMPACT
  Argumentation Toolbox](publications/Gordon2011a.pdf). In Proceedings of the Jurix Workshop on
  Modelling Policy-Making (MPM 2011), 29-38.
- Gordon, T.F. [Combining Rules and Ontologies with
  Carneades](publications/Gordon2011b.pdf). Proceedings of the 5th International RuleML2011@BRF
  Challenge, CEUR Workshop Proceedings (2011), 103-110.
- Gordon, T.F. [Analyzing Open Source License Compatibility Issues with
  Carneades](publications/Gordon2011c.pdf). Proceedings of the Thirteenth International Conference on
  Artificial Intelligence and Law (ICAIL-2011), ACM Press (2011),
  50-55.
- Gordon, T. F., & Walton, D. (2011). [A Formal Model of Legal Proof
  Standards and Burdens](publications/GordonWalton2011a.pdf). In F. van Emeren, B. Garssen, J. A. Blair, &
...
- Gordon, T.F. [Report on a Prototype Decision Support System for OSS
  License Compatibility Issues](publications/Gordon2010a.pdf). Qualipso (IST- FP6-IP-034763),
  Deliverable A1.D2.1.3, 2010.
- Gordon, T.F. [An Overview of the Carneades Argumentation Support
  System](publications/Gordon2010b.pdf). In C.W. Tindale and C. Reed, Dialectics, Dialogue and
...
- Brewka, G. and Gordon, T.F. [Carneades and Abstract Dialectical
  Frameworks: A Reconstruction](publications/BrewkaGordon2010a.pdf). Computational Models of Argument –
...
- Ballnat, S. and Gordon, T.F. [Goal Selection in Argumentation
  ...
  Structures](publications/BallnatGordon2010a.pdf). Computational Models of Argument – Proceedings of COMMA
...
- Grabmair, M., Gordon, T.F., and Walton, D. [Probabilistic Semantics
  ...
  Networks](publications/GrabmairGordonWalton2010a.pdf). Computational Models of Argument – Proceedings of COMMA
  2010, IOS Press (2010), 255–266.

# 2009

- Gordon, T.F. [Foundations of Argumentation Technology – Summary of
  Habilitation Thesis](publications/Gordon2009a.pdf). Technical University of Berlin, 2009.
- Gordon, T. F., Governatori, G., and Rotolo, A. [Rules and norms:
  Requirements for rule interchange languages in the legal domain. In
  Rule Representation, Interchange and Reasoning on the Web](publications/GordonGovernatoriRotolo2009a.pdf) (Berlin,
...
- Walton, D., and Gordon, T. F. [Jumping to a conclusion: Fallacies and
  standards of proof](publications/WaltonGordon2009a.pdf). Informal Logic 29, 2 (2009), 215–243.
- Bench-Capon, T., and Gordon, T. F. [Isomorphism and argumentation](publications/BenchCaponGordon2009a.pdf). In
...
- Lauritsen, M., and Gordon, T. F. [Toward a general theory of document
  modeling](publications/LauritsenGordon2009a.pdf). In 12th International Conference on Artificial
  Intelligence and Law (ICAIL 2009) (New York, NY, USA, 2009),
  C. D. Hafner, Ed., ACM Press.
- Gordon, T. F., and Walton,
  D. [Legal reasoning with argumentation schemes](publications/GordonWalton2009a.pdf). In
  12th International Conference on Artificial Intelligence and Law
  (ICAIL 2009) (New York, NY, USA, 2009), C. D. Hafner, Ed., ACM
  Press.
- Gordon, T. F., and Walton, D. [Proof burdens and standards](publications/GordonWalton2009b.pdf). In
  Argumentation in Artificial Intelligence, I. Rahwan and G. Simari,
  Eds. Springer-Verlag, Berlin, Germany, 2009, 239-260.
- Gordon, T. F. [Juristische Argumentation als Modellierungsprozess](publications/Gordon2009b.pdf). In
...
- Macintosh, A., Gordon, T. F., and Renton, A. [Providing argument
  support for e-participation](publications/MacintoshGordonRenton2009a.pdf). Journal of Information Technology &
  Politics 6, 1 (2009), 43–59.

# 2008

- Gordon, T. F. [Constructing legal arguments with rules in the legal
  knowledge interchange format (LKIF)](publications/Gordon2008a.pdf). In Computable Models of the
...
- Gordon, T. F. [The Legal Knowledge Interchange Format
  (LKIF)](publications/Gordon2008b.pdf). Deliverable 4.1, European Commission, 2008.
- Gordon, T. F. [Hybrid reasoning with argumentation schemes](publications/Gordon2008c.pdf). In
  Proceedings of the 8th Workshop on Computational Models of Natural
  Argument (CMNA 08) (July 2008).

# 2007

- Gordon, T. F. (2007). [20 Years of ICAIL: Reflections on the Field of AI and Law. International Conference on Artificial Intelligence and Law (ICAIL 2007)](publications/GordonICAIL2007b.pdf). ([OpenDocument format](publications/GordonICAIL2007b.otp) License: Attribution-ShareAlike 4.0 International.
- Gordon, T. F. [Visualizing Carneades argument graphs](publications/Gordon2007a.pdf). Law,
  Probability and Risk 6, 1-4 (2007), 109–117.
- Gordon, T. F. [Constructing arguments with a computational model of
  an argumentation scheme for legal rules](publications/Gordon2007b.pdf). In Proceedings of the
...
- Gordon, T. F., Prakken, H., and Walton, D. [The Carneades model of
  argument and burden of proof](publications/GordonPrakkenWalton2007b.pdf). Artificial Intelligence 171, 10-11
  (2007), 875–896.
- Apostolou, D., Babic, F., Bafoutsou, G., Butka, P., Dioudis, S.,
  ...
  technologies](publications/ApostolouEtAl2007a.pdf). Technical report, DemoNet – EU IST Network of
  Excellence.

# 2006

- Gordon, T. F., and Walton, D. [Pierson vs. Post revisted — a
  reconstruction using the Carneades Argumentation Framework](publications/GordonWalton2006b.pdf). In
...
- Gordon, T. F., and Walton, D. [The Carneades argumentation framework
  — using presumptions and exceptions to model critical questions](publications/GordonWalton2006a.pdf). In
  Proceedings of the First International Conference on Computational
  Models of Argument (COMMA 06) (Liverpool, September 2006),
  P. E. Dunne, Ed.
- Gordon, T. F. Encyclopedia of Digital Government. Idea Group,
  Hershey, Pennsylvania, 2006, ch. [Legal Knowledge Systems](publications/Gordon2006b.pdf),
  pp. 1161–1166.

# 2005

- Gordon, T. F. [Information technology for good governance](publications/Gordon2005c.pdf). In
...
- Gordon, T. F. [Artificial intelligence and legal theory at law
  schools](publications/Gordon2005b.pdf). In Artificial Intelligence and Legal Education (Bologna,
  Italy, 2005), H. Yoshino, K. D. Ashley, and K. Nitta, Eds., Gedit
  Edizioni, pp. 53–58.
- Walton, D., and Gordon, T. F. [Critical questions in computational
  models of legal argument](publications/WaltonGordon2005a.pdf). In Argumentation in Artificial
...
- Gordon, T. F. (2005). [A computational model of argument for legal
  reasoning support systems](publications/Gordon2005a.pdf). In Dunne, P. E. and Bench-Capon, T.,
...
- Glassey, O., and Gordon, T. F. [Feasibility study for a legal
  knowledge system in the County of Herford](publications/GlasseyGordon2005a.pdf). In Electronic Government
...
- Glassey, O., Gordon, T., and Pattberg, J. [Machbarkeitstudie eines
  wissenbasierten Rechtsberatungssystems im Kreis Herford](publications/GlasseyGordonPattberg2005b.pdf). In
...
- Gordon, Thomas F. "[Die Bedeutung von eGovernance für die Öffentliche
  Verwaltung](publications/Gordon2004c.pdf)." Verwaltung und Management 10.5 (2004): 258–63.
- Gordon, Thomas F. "[eGovernance and its Value for Public
  Adminsitration](publications/Gordon2004b.pdf)." Knowledge-Based Services for the Public
  Sector. Ed. Donato Malerba. Bonn, 2004.

# 2003

- Gordon, Thomas F. [On the Need for Standard Document Formats for
  Egovernance Applications of Legal Knowledge-Based Systems](publications/Gordon2003c.pdf). Workshop
  on Artificial Intelligence to Support eGovernment. Cambridge,
  UK, 2003.
- Gordon, Thomas F. [A Use Case Analysis of Legal Knowledge-Based
  Systems](publications/Gordon2003b.pdf). Legal Knowledge and Information Systems (JURIX
  2003). Utrecht: IOS Press,
- Gordon, Thomas F. [An Open, Scalable and Distributed Platform for
  Public Discourse](publications/Gordon2003a.pdf). Informatik 2003. Eds. Klaus Dittrich, et
...
- Gordon, Thomas F., and Oliver Märker. "[Mediation Systems ." Neue
  ...
  Wirtschaft](publications/GordonMärker2002a.pdf). Eds. Oliver Märker and Matthias Trénel. Berlin: Edition
  Sigma, 2002. 61-84.
- Gordon, Thomas F., and Gernot Richter. "[Discourse Support Systems
  for Deliberative Democracy](publications/GordonRichter2002a.pdf)." eGovernment: State of the Art and
...
- Märker, Oliver, et al. "[Internet-Based Citizen Participation in the
  City of Esslingen. Relevance - Moderation - Software](publications/MärkerHagedornTrenelGordon2002b.pdf)." Corp 2002 -
...
- Gordon, Thomas F., and Oliver Märker. "[Mediation Systems ."
  Sustainability in the Information Society](publications/GordonMärker2001a.pdf); 15th International
...
- Gordon, Thomas F., Angi Voss, Gernot Richter and Oliver
  Märker. "[Zeno: Groupware for Discourses on the Internet](publications/GordonVossRichterMärker2001b.pdf)." Künstliche
  Intelligenz 2.1 (2001): 43-45.

# 1999

- Schmidt-Belz, Barbara, Thomas F. Gordon, and Hans Voss. "[Urban
  Planning with Geomed - First User Experiences](publications/Schmidt-BelzGordonVoss1999a.pdf)."Eurocities, 4th
  European Digital Cities Conference. Salzburg, 1999. 135-38.
- Prakken, Henry., and Thomas F. Gordon. [Rules of order for electronic
  group decision making — a formal methodology](publications/PrakkenGordon1999a.pdf). In Collaboration
...
- Gordon, Thomas F., and Nikos Karacapilidis. "[The Zeno Argumentation
  Framework](publications/GordonKaracapilidis1997a.pdf)." Proceedings of the Sixth International Conference on
  Artificial Intelligence and Law. Melbourne, Austrailia, 1997. 10-18.

# 1996

- Gordon, Thomas F. "[Computational Dialectics](publications/Gordon1996a.pdf)." Computers as
...
- Brewka, Gerhard, Thomas F. Gordon, and Nikos
  ...
  Zeno System](publications/BrewkaGordonKaracapilidis1995a.pdf)." KI-95 Workshop on Computational Dialectics: Models of
  Argumentation, Negotiation and Decision Making, 1995.
- Karacapilidis, Nikos I., and Thomas F. Gordon. "[Dialectical
  Planning](publications/KaracapilidisGordon1995b.pdf)." Proceedings of 14th International Joint Conference on
...
- Brewka, Gerhard, and Thomas F. Gordon. "[How to Buy a Porsche: An
  Approach to Defeasible Decision Making](publications/BrewkaGordon1994a.pdf)." Working Notes of the
...
- Gordon, Thomas. F. [The Pleadings Game — an exercise in computational
  dialectics](publications/Gordon1994a.pdf). Artificial Intelligence and Law 2, 4 (1994), 239–292.

# 1993

- Gordon, Thomas. F. [The Pleadings Game; formalizing procedural
  justice](publications/Gordon1993b.pdf). In Proceedings of the Fourth International Conference on
  Artificial Intelligence and Law. 1993, pp. 10–19.
- Gordon, Thomas F. 1993. [The Pleadings Game; An Artificial
  Intelligence Model of Procedural Justice](publications/Gordon1993a.pdf). PhD Thesis. Technical
  University of Darmstadt.

# 1992

- Gordon, Thomas F. "[Artificial Intelligence: A Hermeneutic Defense ."
  Software Development and Reality Construction](publications/Gordon1992a.pdf). Ed. Christiane Floyd
...
- Gordon, Thomas F. "[A Theory Construction Approach to Legal Document
  Assembly](publications/Gordon1992b.pdf)." Expert Systems in Law. Ed. Antonio
  A. Martino. Amsterdam, 1992. 211-25.

# 1991

- Gordon, Thomas F. "[An Abductive Theory of Legal Issues](publications/Gordon1991a.pdf)."
  International Journal of Man-Machine Studies 35 (1991): 95-118.

# 1989

- Gordon, Thomas F. "[Issue Spotting in a System for Searching
  Interpretation Spaces](publications/Gordon1989a.pdf)." Proceedings of the Second International
  Conference on Artificial Intelligence and Law. 1989. 157-64.

# 1988

- Gordon, Thomas F. [The Argument Construction Set – A Constructive
  Approach to Legal Expert Systems](publications/Gordon1988b.pdf): German Research Institute for
  Mathematics and Data Processing (GMD), 1988.
- Gordon, Thomas F. "[The Importance of Nonmonotonicity for Legal
  Reasoning](publications/Gordon1988a.pdf)." Expert Systems in Law; Impacts on Legal Theory and
...
- Gordon, Thomas F. "[Oblog-2: A Hybrid Knowledge Representation System
  for Defeasible Reasoning](publications/Gordon1987c.pdf)." International Conference on Artificial
  Intelligence and Law. Boston, 1987. 231-39.
- Gordon, Thomas F. "[Some Problems with Prolog as a Knowledge
  Representation Language for Legal Expert Systems](publications/Gordon1987b.pdf)." Yearbook of Law,
